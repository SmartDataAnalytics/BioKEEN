...
from pybel.constants import (
    ACTIVITY, CORRELATIVE_RELATIONS, DIRECTLY_DECREASES, EQUIVALENT_TO, HAS_COMPONENT, IS_A, MODIFIER, OBJECT, PART_OF,
    REGULATES, RELATION, TRANSCRIBED_TO, TRANSLATED_TO,
)
